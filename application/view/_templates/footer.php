    ...
    <!-- iCheck -->
    <script src="<?php echo URL;?>admin/vendors/iCheck/icheck.min.js"></script>
    <!-- Skycons -->
    ...
    <!-- JQVMap -->
    <script src="<?php echo URL;?>admin/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?php echo URL;?>admin/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo URL;?>admin/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    ...
    <script src="<?php echo URL;?>admin/vendors/jszip/dist/jszip.min.js"></script>
    <script src="<?php echo URL;?>admin/vendors/pdfmake/build/pdfmake.min.js"></script>
    <script src="<?php echo URL;?>admin/vendors/pdfmake/build/vfs_fonts.js"></script>
     <!-- jQuery Smart Wizard -->
    <script src="<?php echo URL;?>admin/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js"></script>
