...
<head>
  ...
  <!-- progress barstle -->
  <link rel="stylesheet" href="<?php echo URL; ?>html/css/css-circular-prog-bar.css">
  <!-- fonts style -->
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo URL; ?>user/index">Login</a>
                </li>
              </ul>
            </div>
        </nav>
    ...
    <section class="hero_section ">
      <div class="hero-container container">
        ...
        <div class="hero_img-container">
          <div>
            <img src="<?php echo URL; ?>html/images/hero.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="about_img-container">
              <img src="<?php echo URL; ?>html/images/about.png" alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="admission_img-container">
              <img src="<?php echo URL; ?>html/images/admission.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="why_img-container">
              <img src="<?php echo URL; ?>html/images/why.png" alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="determine_img-container">
              <img src="<?php echo URL; ?>html/images/determine.png" alt="">
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="row">
                      <div class="col-md-3">
                        <div class="client_img-box">
                          <img src="<?php echo URL; ?>html/images/client.png" alt="">
                        </div>
                      </div>
                      <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="contact_img-box">
                <img src="<?php echo URL; ?>html/images/students.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
